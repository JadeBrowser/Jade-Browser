...
onload = function() {
  //Jade note: this is where webview is declared. It's the attribute of some document thingie. I'll look up document.
  ...
  document.querySelector('#enter').onclick = function() {
    var getvalue=document.getElementById("theURL").value;
    navigateTo(getvalue);
  };
